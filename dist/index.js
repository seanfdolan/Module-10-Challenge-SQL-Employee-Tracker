        ...
        if (answers.prompt === 'View All Departments') {
            ...
            db.query('SELECT * FROM department', (err, results) => {
                ...
                inquirer.prompt([
                    ...
                    const selectedDepartment = results.rows.find((dept) => dept.name === answers.department);
            ...
            db.query('SELECT * FROM department', (err, results) => {
                if (err)
                    throw err;
                const departmentBudgetAnswers = answers;
                departmentBudgetAnswers.salary = results.rows.map((result) => result.salary);
                ...
                inquirer.prompt([
                    ...
                    employee_tracker();
                    const department = results.rows.find((dept) => dept.name === answers.department);
